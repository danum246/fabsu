...
<table class="datatable" style="width:100%">
	...
	if($ppn==0 and $pph==0){?> 
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_2" id="acc_dr_2"  class="get_addcoaacno2 mytextbox"  value="<?=@$row1->acc_no;?>" style="width:100%"></td>
		<td align="center"><input type="text"  name="name_dr_2" id="name_dr_2"  class="auto-add_name2 mytextbox" value="<?=@$row1->acc_name;?>" style="width:100%"></td>
		<td align="right"><input type="text"   name="acc_debet_2" id="acc_debet_2" class="mytextbox" value="<?=@number_format(replace_numeric($kredit));?>"  style="text-align:right;width:100%"></td>
		<td align="center"><input type="text"  name="acc_credit_2" id="acc_credit_2" class="mytextbox" value="0"  style="text-align:right;width:100%"></td>
	</tr>
	...
	<tr height="25px">
		<td align="center"><input type="text"  name="acc_dr_2" id="acc_dr_2"  class="get_addcoaacno2 mytextbox"  value="<?=@$row1->acc_no;?>" style="width:100%"></td>
		<td align="center"><input type="text"  name="name_dr_2" id="name_dr_2"  class="auto-add_name2 mytextbox" value="<?=@$row1->acc_name;?>" style="width:100%"></td>
		<td align="right"><input type="text"   name="acc_debet_2" id="acc_debet_2" class="mytextbox" value="<?=@number_format($i);?>"  style="text-align:right;width:100%"></td>
		<td align="center"><input type="text"  name="acc_credit_2" id="acc_credit_2" class="mytextbox" value="0"  style="text-align:right;width:100%"></td>
	</tr>
	<?php } ?>
	<?php }else{ 
	...
	<tr height="25px">
		...
		<td align="center"><input type="text"  name="name_dr_5" id="name_dr_5"  class="mytextbox auto-add_name5"  value="<?php echo $datrow->remark;?>" style="width:100%"></td>
	...
	<tr height="25px">
		...
		<td align="center"><input type="text"  name="name_dr_<?php echo $nm;?>" id="name_dr_<?php echo $nm;?>"  class="mytextbox auto-add_name<?php echo $nm;?>"  value="<?php echo $row->acc_name;?>" style="width:100%"></td>
	...
	<tr height="25px">
		...
		<td align="center"><input type="text"  name="name_dr_3"  id="name_dr_3"  class="mytextbox auto-add_name3" value="<?=$ppni->acc_name;?>" style="width:100%"></td>
	...
	<tr>
		...
		<td><input type="text" id="total_debet" style="text-align:right;background-color:#EFFC94;width:100%" class="mytextbox calculate"></td>
		<td><input type="text" id="total_credit" style="text-align:right;background-color:#EFFC94;width:100%" class="mytextbox calculate"></td>
	</tr>
	<?php }else{?>
	<tr>
		<td colspan="2"> <b>GRAND TOTAL </b></td>
		...
		<input type="text" id="total_debetac" style="text-align:right;background-color:#EFFC94;width:100%" class="mytextbox calculate" value="">
		</td>
		<td>
		...
		<input type="text" id="total_creditac" style="text-align:right;background-color:#EFFC94;width:100%" class="mytextbox calculate" value="">
		</td>
	</tr>
	<?php } ?>
	<!-- end update danu -->
...
<script type="text/javascript"> 
	...
	if($('#acc_debet_2').val()){
	var db2 = $('#acc_debet_2').val().replace(/,/g,'');
	}else{
	var db2 = 0;
	} 
	if($('#acc_debet_3').val()){

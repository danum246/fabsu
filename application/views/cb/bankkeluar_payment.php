...
<td>Trans Date</td>
	...
	<tr>
		<td>Amount</td>			
			<td>:</td>
			<td><input type="text" class="calculate input validate[required]" name="amount" id="amount" value="<?php echo number_format($row->amount)?>"  style="width:180px;background-color:#EFFC94" readonly="true" size="30" /></td>

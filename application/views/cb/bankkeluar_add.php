...
<body>
	...
	<tr>
		<td>Jumlah Bayar</td>
			<td>:</td>			
			<td>
            <input type="text" name="amount" class="calculate" id="amount" value="<?php echo number_format($row->base_amt);?>" style="width:220px;border:1px solid lightgray;padding:3px">
			</td>
		<td>Sisa Pembayaran</td>
			<td>:</td>
			<td>
			<input type="text" name="balance" id="balance" value="" style="width:220px;border:1px solid lightgray;padding:3px">
			</td>
	...
	<td colspan=10>
		...
		<tr align="center">
			...
			<td><input type="text" name="amount<?php echo $no;?>" value="" class="calculate" style="text-align:right;width:150px;border:1px solid dimgray;padding:3px"></td>
		</tr>
		<?php $no++; } ?>

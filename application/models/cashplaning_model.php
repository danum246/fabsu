...
class cashplaning_model extends DBModel{		
	function __construct(){ 
	 ...
	 function before_fetch(){
		...
		$this->db->select('d.plan_date,a.apinvoice_id as apinvoice_id,a.status as status,a.doc_no as doc_no,b.nm_supplier as nm_supplier,a.doc_date as doc_date,a.descs as descs,a.base_amt as base_amt');
